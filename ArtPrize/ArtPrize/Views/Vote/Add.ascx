 ...
 <form method="post" id="vota-artprize" action="/Vote/Add" novalidate="novalidate">
            ...
            <label for="birthday">
                ...
                <p class="privacy_accept">
					Dichiaro di aver preso visione dell’<a title="informativa sulla privacy" href="/Home/Privacy">informativa sulla privacy</a> e di acconsentire al trattamento dei miei dati da parte della Banca per le finalità menzionate alle lettere (a) e (b) della suddetta informativa.
					<br>
				    <span>
				...
				<p class="terms_accept">
					...
					<br>
					<span>
                        <input type="radio" value="True" name="User.TermsAcceptance" id="User_TermsAcceptance"/>do il consenso                                         
                    </span>
					<span>
						<input type="radio" value="False" name="User.TermsAcceptance" id="User_TermsAcceptance_NO" checked="checked"/>nego il consenso
                    </span>
